...
const TodoList = () => {
  ...
  return ( 
    <div className="flex items-center justify-center h-screen" style={{ backgroundImage: 'url(https://img.freepik.com/free-vector/detailed-hand-painted-pink-watercolour-background_1048-17039.jpg)', backgroundSize: 'cover' }}>
      <div className="w-full max-w-lg px-4 py-16 sm:px-0">
        <Tab.Group onChange={(index) => setSelectedTab(index === 0 ? 'Todo List' : 'Completed')}>
          <Tab.List className="flex space-x-4 rounded-xl bg-pink-200 p-2 w-full">
              ...
              <Tab
                ...
                className={({ selected }) =>
                  classNames(
                    ...
                    'ring-white/60 ring-offset-2 ring-offset-pink-400 focus:outline-none focus:ring-2',
                    selected ?
              ...
              >
                {tabName === 'Todo List' && (
                  <div className="mb-4 flex items-center space-x-2 text-gray">
                    <input
                      ...
                      style={{ backgroundColor: '#FCE4EC', color: 'black' }}
                    ...
                    <button
                      className={classNames(
                        ...
                        'w-24 bg-pink-500 text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-400',
                        'hover:bg-pink-600 transform-gpu transition-transform hover:scale-110'
                      )}
                ...
                <ul className="overflow-y-auto max-h-96">
                  {posts.map((post) => (
                    ...
                    >
                      <h3 className={`text-lg leading-6 ${post.completed ? 'text-pink-500' : 'text-gray-900'}`}>
                        {post.title}
                      </h3>
                      {tabName === 'Todo List' && (
                      ...
                      {tabName === 'Completed' && post.completed && ( 
                        <div>
                          ...
                          >
                            Completed on: {new Date(post.completionDate).toLocaleString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                          </p>
                        </div>
                      )}
                    </li>
        ...
        {editModalVisible && ( 
          <div className="fixed inset-0 z-10 overflow-y-auto flex items-center justify-center ">
            <div className="absolute inset-0 bg-pink-500 bg-opacity-75"></div>
            <div className="bg-white p-10 rounded-lg z-20">
              ...
              <div className="flex items-center justify-end mt-4">
                <button
                  ...
                  className="rounded-lg py-2 px-4 text-sm font-semibold leading-5 bg-pink-500 text-white focus:outline-none hover:bg-pink-600 transform-gpu transition-transform hover:scale-110"
                >
